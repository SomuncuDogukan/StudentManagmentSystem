                            ...
                            // database operations functionality through Entity Framework
{
    ...
    public DbSet<Student> Students { get; set; } // Users table

    public DbSet<Grade> Grades { get; set; } // Roles table

    public DbSet<Course> Courses { get; set; } // Resources table

    public DbSet<StudentCourse> StudentCourses { get; set; } // UserResources table
